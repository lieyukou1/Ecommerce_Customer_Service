...
from atguigu.task.action.custom.objects import build_object_messages, build_work_order_object


class AnswerResidentWorkOrders(Action):
    """
    功能：查询当前住户的工单列表，并返回对象消息。
    """
    ...
    async def run(self, state: DialogueState, action_kwargs: dict[str, Any]) -> ActionResult:
        ...
        输出：
        - ActionResult: 包含工单对象消息列表；没有数据时返回兜底文本。
